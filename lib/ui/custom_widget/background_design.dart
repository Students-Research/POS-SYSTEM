...
class RPSCustomPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    Paint paint0 = Paint()
      ..color = const ui.Color(0xff3A42FA).withOpacity(0.7)
    ...
    // canvas.drawShadow(
    //     path0, Color.fromARGB(255, 235, 14, 14).withOpacity(0.20), 0.7, true);

    Paint paint1 = Paint()
      ..color = const Color(0xff3A42FA).withOpacity(0.4)
      ..style = PaintingStyle.fill
      ..strokeWidth = 1.0;
